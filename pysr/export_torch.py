"""
This module contains functionality to export expressions to PyTorch.

Much of this code is borrowed from https://github.com/patrick-kidger/sympytorch
to allow PySR-specific tweaks.
"""

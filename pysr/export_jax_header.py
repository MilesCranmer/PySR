"""Header for export_jax.py, so we loading jax is optional."""
...
def sympy2jax(expression, symbols_in, selection=None, extra_jax_mappings=None):
    ...
    # Examples:
        ...
        ```
    """
    from .export_jax import _sympy2jax

    return _sympy2jax(expression, symbols_in, selection=selection, extra_jax_mappings=extra_jax_mappings)
